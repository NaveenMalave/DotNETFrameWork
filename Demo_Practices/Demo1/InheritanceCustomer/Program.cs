...
namespace InheritanceCustomer
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            if (op == 1)
            {
                Customer customer1 = new SeniorCitizonCustomer();
               Console.WriteLine("amount"+ customer1.GenerateBillAmount(amt));
                
            }
            else if (op == 2)
            {
                Customer customer2 = new Customer();
                customer2.GenerateBillAmount(amt);
